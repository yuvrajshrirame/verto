...
const AnimatedBackground = () => {
  return (
    <div className="fixed inset-0 z-[-1] bg-[#0f1117] overflow-hidden">
      {/* Shifted to a dark gray/slate base so the lines are more visible */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-emerald-950/20 via-[#0f1117] to-[#090a0f]"></div>
